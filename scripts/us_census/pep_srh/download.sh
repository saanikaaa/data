...
do
    `echo "curl https://www2.census.gov/programs-surveys/popest/datasets/1990-2000/counties/asrh/${file}" \
          "-o ./download_files/1990_2000/county/${file}"`
done

for file in `cat download_county_files_2000_2010.txt`
do
    `echo "curl https://www2.census.gov/programs-surveys/popest/datasets/2000-2010/intercensal/county/${file}" \
...
do
    `echo "curl https://www2.census.gov/programs-surveys/popest/datasets/2010-2020/counties/asrh/${file}" \
...
do
    `echo "curl https://www2.census.gov/programs-surveys/popest/datasets/1980-1990/state/asrh/${file}" \
...
do
    `echo "curl https://www2.census.gov/programs-surveys/popest/tables/1990-2000/state/asrh/${file}" \
